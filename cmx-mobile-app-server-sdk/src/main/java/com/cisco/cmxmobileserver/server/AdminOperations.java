package com.cisco.cmxmobileserver.server;
...
import com.cisco.cmxmobileserver.utils.CmxSdkProperties;
...
public class AdminOperations {
    ...
    public static final String LOGGING_BASE_URL = "/api/cmxmobileserver/v1/admin/logging";
    ...
    public void changeLoggingConfiguration(String loggingLevel) {
        ...
        try {
            String url = SERVER_BASE_URL + CmxSdkProperties.getInstance().getWebappPort() + "/" + CmxSdkProperties.getInstance().getWebapContextPath() + LOGGING_BASE_URL;
